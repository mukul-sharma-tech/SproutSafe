...
The CyberNest backend is a Node.js + Express API that powers the parental-control dashboard and monitoring features. It exposes REST endpoints for parent authentication, child profile management, and tracking of children’s browsing activity, backed by MongoDB via Mongoose.

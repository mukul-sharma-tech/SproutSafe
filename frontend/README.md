...
CyberNest Dashboard is a full-featured web dashboard for parental control, built using React, TypeScript, Vite, and Tailwind CSS. It allows parents to monitor, manage, and protect their children’s online activity across devices with a simple and interactive interface.
                  
This `frontend/` app consumes the CyberNest backend REST API and presents a modern, responsive UI for parents.
...
CyberNest Dashboard is designed to empower parents with tools to ensure their children’s online safety. By combining real-time-style monitoring, protection toggles, and analytics in a single interface, it helps parents gain peace of mind while children explore the digital world safely.

...
const testimonials = [
  { quote: "CyberNest gives me peace of mind knowing my kids are protected online without feeling like I'm invading their privacy.", author: "Sarah Johnson", role: "Mother of two" },
...
const faqs = [
  { question: "Does CyberNest monitor private conversations?", answer: "No. CyberNest scans page content for safety risks but doesn't record or store private conversations, messages, or keystrokes." },
  ...
  { question: "Can my child disable it?", answer: "No. Changing or removing CyberNest requires parent authentication. You'll also get notified if someone tries to uninstall it." },
        ...
        <section className="relative py-28 px-6 overflow-hidden">
          <ScrollReveal className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-md mx-auto">
              Set up CyberNest in under 5 minutes and see exactly what your child encounters online.
            </p>

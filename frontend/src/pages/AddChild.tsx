...
import { UserPlus, Copy, Check, Loader2, Sprout, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        <div className="flex justify-center mb-8">
          <Link to="/dashboard" className="flex items-center gap-2.5 group">
            ...
            <span className="text-2xl font-bold">SproutSafe</span>
          </Link>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col items-center gap-3 rounded-xl border bg-card p-4">
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      Open the SproutSafe extension and tap <span className="font-semibold">"Scan QR"</span>, or paste the
                      token below.
                    </p>
                  </div>

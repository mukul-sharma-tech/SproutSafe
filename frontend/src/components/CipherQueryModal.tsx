            ...
            <div className="bg-card border border-border rounded-xl w-full max-w-md overflow-hidden relative shadow-2xl animate-in fade-in zoom-in duration-300">
                <div className="p-6 max-h-[90vh] overflow-y-auto">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold">CyberNest Verification</h2>
                        {!isMandatory && (
                    ...
                    {step === "success" && (
                        <div className="py-12 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-muted-foreground mb-8 max-w-[250px] mx-auto">Your request has been successfully submitted to CyberNest.</p>

export const voiceStrings = {
  en: {
    stepAuth: "Welcome to SproutSafe. Please sign in or create an account.",
    ...
    tokenCopied: "Token has been copied to clipboard. Paste it in the SproutSafe extension.",
    childAdded: "Child profile has been added successfully.",
  },
  hi: {
    stepAuth: "SproutSafe में आपका स्वागत है। कृपया साइन इन करें या खाता बनाएं।",
    ...
    tokenCopied: "टोकन क्लिपबोर्ड पर कॉपी हो गया है। इसे SproutSafe एक्सटेंशन में पेस्ट करें।",
